        ...
        {data && !!data.length && (
          <>
                    ...
                    >
                      <div
                        style={{
                          ...
                          filter:
                            filterCondition.linhVucDuAn && filterCondition.linhVucDuAn !== ele.id
                              ? 'blur(2px)'
                              : 'unset',
                          transition: 200
                        }}
            ...
            <Flex style={{ background: 'white', padding: 16, borderRadius: 6, position: 'relative' }} gap={20}>
              ...
              ></div>
              {[2020, 2021, 2022, 2023, 2024, 2025, 2026, 2027].map((ele, index) => <Flex
                key={index}
                      ...
                      <Flex align="center" justify="space-between" style={{ textAlign: 'right' }}>
                        ...
                        {item.ngay_het_hop_dong && (
                          <div style={{ fontWeight: 600 }}>
                            {moment(item.ngay_het_hop_dong).diff(moment(item.ngay_bat_dau_hop_dong), 'months') + 1}{' '}
                            tháng
                          </div>
                        )}
                      </Flex>
